    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent showOverlay>
        ...
        <DialogDescription className="mb-4">
          These are the labels Orbit uses to autolabel your incoming emails. Feel free to modify them
          however you like. Orbit will create a new label in your account for each label you add - if
          ...
          <Button
            ...
            onClick={() => {
              updateLabels({ labels: labels.map((label) => label.text) }).then(() => {
                setOpen(false);
                toast.success('Labels updated successfully, Orbit will start using them.');
              });
            }}
          >
            Save
